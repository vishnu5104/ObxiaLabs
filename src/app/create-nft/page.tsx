...
import { CollectionV1, create, mplCore } from '@metaplex-foundation/mpl-core';
  ...
  const createCollectionNFT = useCallback(async () => {
    ...
    try {
      ...
      const collection: CollectionV1 = {
        publicKey: publicKey(colkey), // Create a PublicKey instance
      ...
      setResult({
        collectionAddress: asset.publicKey,
        signature: signature,
      });
